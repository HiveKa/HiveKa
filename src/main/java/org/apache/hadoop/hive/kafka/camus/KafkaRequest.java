...
public class KafkaRequest implements CamusRequest {
  ...
  /**
   * Constructor for a KafkaKafkaRequest with the uri set to null and offset set
  ...
  /**
   * Constructor for the KafkaKafkaRequest with the offset to -1.
   *
   * @param topic
   *            The topic name
   * @param leaderId
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof KafkaRequest)) return false;
  ...
  /**
   * Returns the copy of KafkaRequest
   */
  @Override
